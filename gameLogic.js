...
function setImage(choice, img, isFlip) {
    switch(choice) {
        case 'rock': 
            img.src = "./Rock.svg";
        break;
        case 'paper': img.src = "./Paper.svg";
        break;
        case 'scissors': img.src = "./Scissors.svg";
        break;
    }
    if(isFlip) {
...
function logicHandle(playerChoice, computerChoice) {
    if(playerChoice == 'rock') {
        switch(computerChoice) {
            ...
            break;
            case 'paper': computerScore.innerText += star;
            break;
            case 'scissors': playerScore.innerText += star;
            break;
        }
    }
    else if(playerChoice == 'paper') {
        switch(computerChoice) {
            case 'rock': playerScore.innerText += star;
            break;
            case 'paper': //result.innerText = "Draw";
            break;
            case 'scissors': computerScore.innerText += star;
            break;
        }
    }
    else if(playerChoice == 'scissors') {
        switch(computerChoice) {
            case 'rock': computerScore.innerText += star;
            break;
            case 'paper': playerScore.innerText += star;
            break;
